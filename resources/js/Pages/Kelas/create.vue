...
const props = defineProps({
  auth: { type: Object },
  classes_for_student: { type: Object },
...
function submit() {
  ...
  formData.post(route('matapelajaran.store'), {
    ...
    onError: (errors) => {
      ...
      console.log('Form Data submitform:', formData);
                ...
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                  <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                      Gunakan Form ini untuk mengisi data Kelas
                    </p>
                  </div>
                  ...
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <InputError
                        class="mt-2"
                        :message="formData.errors.nama_kelas"
                      />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                      <label
                      ...
                      <InputError
                        class="mt-2"
                        :message="formData.errors.wali_kelas"
                      />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                      <label
                      ...
                      <InputError
                        class="mt-2"
                        :message="formData.errors.kode_mapel"
                      />
                    </div>
