    ...
    if (savedEntries) {
        ...
        const defaultEntries = [
            ...
            },
            {
                ...
                action: "Diminta mengganti seragam sesuai ketentuan sebelum memasuki kelas",
        ...
        <main class="p-7 md:ml-64 h-screen pt-20">
            ...
            <div class="container mx-auto px-4 py-6">
                <div class="container mx-auto px-4 py-6">
                    ...
                    >
                        <span class="text-lg text font-semibold"
                            >Tampilkan Opsi</span
                        >
                    </div>
            ...
            <div id="app" class="p-6 bg-gray-100 min-h-screen">
                ...
                >
                    ...
                    />
                    <h1
                        class="text-xl md:text-2xl font-bold text-center md:text-left"
                    >
