  ...
  <div class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <main class="p-4 md:ml-64 h-auto pt-20">
      <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Riwayat Penilaian Harian</h1>
        <div class="bg-white p-4 rounded-lg shadow-md">
          ...
          <div class="mt-4">
            <h2 class="text-lg font-semibold">Keterangan Singkatan</h2>
            <ul class="list-disc ml-6">
              <li>
                <strong>BB (Belum Berkembang)</strong>: Siswa masih berada pada
                tahap awal atau belum menunjukkan pemahaman atau kemampuan yang
                memadai terhadap materi yang diajarkan.
              </li>
              <li>
                <strong>MB (Mulai Berkembang)</strong>: Siswa mulai menunjukkan
                pemahaman dan kemampuan terhadap materi, namun masih belum
                konsisten. Siswa masih memerlukan bimbingan dan latihan lebih
                lanjut.
              </li>
              <li>
                <strong>BSH (Berkembang Sesuai Harapan)</strong>: Siswa telah
                mencapai tingkat pemahaman dan kemampuan yang sesuai dengan
                harapan atau standar yang ditetapkan. Siswa menunjukkan kinerja
                yang baik dan konsisten.
              </li>
              <li>
                <strong>BSB (Berkembang Sangat Baik)</strong>: Siswa telah
                melampaui harapan atau standar yang ditetapkan. Siswa
                menunjukkan kinerja yang sangat baik dan memiliki pemahaman yang
