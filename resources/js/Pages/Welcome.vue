  ...
  <div class="overflow-x-hidden antialiased">
    <header class="bg-gray-0 text-white p-4">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="text-2xl font-bold">
          ...
          >
            <img
              ...
              alt="Dashboard Image"
              class="w-auto h-6 text-indigo-600 fill-curren"
            />

            <span class="ml-3 text-3xl text-gray-800"
              >SISTEM MONITORING SISWA<span class="text-pink-500">.</span></span
            >
          </a>
        </div>
        ...
        <div class="hidden md:flex space-x-4">
          <Link
            :href="route('login')"
            class="block px-4 py-2 rounded-lg hover:bg-gray-700 text-black"
            >Login</Link
          >
          <Link
            :href="route('register')"
      ...
      <div class="container mx-auto flex justify-between items-center">
        <div v-if="isMenuOpen" class="md:hidden bg-white text-white mt-4">
          <Link
            :href="route('login')"
            class="block px-4 py-2 hover:bg-gray-700 text-black"
            >Login</Link
          >
          <Link
            :href="route('register')"
      ...
      <svg
        class="absolute top-0 right-0 hidden w-screen max-w-3xl -mt-64 -ml-12 lg:block"
        viewBox="0 0 818 815"
    ...
    >
      ...
      >
        ...
        >
          <p
            class="pr-0 mb-4 text-base font-black text-gray-600 sm:text-lg xl:text-xl lg:pr-20"
          >
            Selamat Datang
          </p>
          <p
          ...
          >
            Kelola dan awasi siswa Anda dengan platform monitoring yang mudah
            digunakan
          </p>
        ...
        <div
          class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10"
          style="position: relative; left: -130px; top: 70px"
        ></div>
      </div>
    </div>
    <!-- HERO SECTION END -->
