...
const currentMonthYear = computed(() => {
    ...
    const targetMonth = (currentMonth + 3) % 12; // Menambah 3 bulan dari bulan sekarang, dan memastikan bulannya valid (0-11)
    const monthName = months[targetMonth]; // Mendapatkan nama bulan berdasarkan targetMonth
