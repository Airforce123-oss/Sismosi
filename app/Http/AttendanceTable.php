...
use PowerComponents\LivewirePowerGrid\{Button, Column, Exportable, Footer, Header, PowerGrid, PowerGridComponent};
    ...
    public function bulkCheckedDelete()
    {
        if (auth()->check()) {
            ...
            try {
                ...
                $this->dispatchBrowserEvent('showToast', ['success' => true, 'message' => 'Data absensi berhasil dihapus.']);
